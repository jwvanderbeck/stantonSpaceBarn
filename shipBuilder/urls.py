...
urlpatterns = patterns('shipBuilder.views',
    ...
    # url(r'^vehicleitems/$', views.VehicleItemList.as_view(), name='vehicleitem-list'),
    # url(r'^vehicleitems/(?P<pk>[0-9]+)$', views.ItemPortDetail.as_view(), name='vehicleitem-detail'),
