...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VehicleItemAvionics'
        db.create_table(u'shipBuilder_vehicleitemavionics', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'shipBuilder', ['VehicleItemAvionics'])

        # Adding model 'VehicleItemPower'
        db.create_table(u'shipBuilder_vehicleitempower', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'shipBuilder', ['VehicleItemPower'])

        # Adding model 'VehicleItemParams'
        db.create_table(u'shipBuilder_vehicleitemparams', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('value', self.gf('django.db.models.fields.FloatField')(default=0.0)),
        ))
        db.send_create_signal(u'shipBuilder', ['VehicleItemParams'])

        # Adding model 'VehicleItemHeat'
        db.create_table(u'shipBuilder_vehicleitemheat', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'shipBuilder', ['VehicleItemHeat'])

        # Adding model 'VehicleItem'
        db.create_table(u'shipBuilder_vehicleitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('itemClass', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('displayName', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('itemType', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('itemSubType', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('manufacturer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shipBuilder.Manufacturer'])),
            ('itemSize', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('power', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shipBuilder.VehicleItemPower'])),
            ('heat', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shipBuilder.VehicleItemHeat'])),
            ('avionics', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shipBuilder.VehicleItemAvionics'])),
        ))
        db.send_create_signal(u'shipBuilder', ['VehicleItem'])

        # Adding M2M table for field itemStats on 'VehicleItem'
        m2m_table_name = db.shorten_name(u'shipBuilder_vehicleitem_itemStats')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('vehicleitem', models.ForeignKey(orm[u'shipBuilder.vehicleitem'], null=False)),
            ('vehicleitemparams', models.ForeignKey(orm[u'shipBuilder.vehicleitemparams'], null=False))
        ))
        db.create_unique(m2m_table_name, ['vehicleitem_id', 'vehicleitemparams_id'])


    def backwards(self, orm):
        # Deleting model 'VehicleItemAvionics'
        db.delete_table(u'shipBuilder_vehicleitemavionics')

        # Deleting model 'VehicleItemPower'
        db.delete_table(u'shipBuilder_vehicleitempower')

        # Deleting model 'VehicleItemParams'
        db.delete_table(u'shipBuilder_vehicleitemparams')

        # Deleting model 'VehicleItemHeat'
        db.delete_table(u'shipBuilder_vehicleitemheat')

        # Deleting model 'VehicleItem'
        db.delete_table(u'shipBuilder_vehicleitem')

        # Removing M2M table for field itemStats on 'VehicleItem'
        db.delete_table(db.shorten_name(u'shipBuilder_vehicleitem_itemStats'))
    ...
    models = {
        ...
        u'shipBuilder.vehicleitem': {
            ...
            'avionics': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['shipBuilder.VehicleItemAvionics']"}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'displayName': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'heat': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['shipBuilder.VehicleItemHeat']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'itemStats': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['shipBuilder.VehicleItemParams']", 'symmetrical': 'False'}),
            'itemSubType': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            'itemType': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'manufacturer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['shipBuilder.Manufacturer']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'power': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['shipBuilder.VehicleItemPower']"})
        },
