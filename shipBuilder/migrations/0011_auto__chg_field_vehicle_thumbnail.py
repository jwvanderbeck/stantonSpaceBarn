...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vehicle.thumbnail'
        db.alter_column(u'shipBuilder_vehicle', 'thumbnail', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Vehicle.thumbnail'
        db.alter_column(u'shipBuilder_vehicle', 'thumbnail', self.gf('django.db.models.fields.URLField')(max_length=200))
