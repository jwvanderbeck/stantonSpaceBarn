...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vehicle.displayName'
        db.alter_column(u'shipBuilder_vehicle', 'displayName', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ItemPort.displayName'
        db.alter_column(u'shipBuilder_itemport', 'displayName', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Vehicle.displayName'
        db.alter_column(u'shipBuilder_vehicle', 'displayName', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'ItemPort.displayName'
        db.alter_column(u'shipBuilder_itemport', 'displayName', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
