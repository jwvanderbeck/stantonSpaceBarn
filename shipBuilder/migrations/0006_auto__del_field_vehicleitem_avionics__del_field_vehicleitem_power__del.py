...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VehicleItem.avionics'
        db.delete_column(u'shipBuilder_vehicleitem', 'avionics_id')

        # Deleting field 'VehicleItem.power'
        db.delete_column(u'shipBuilder_vehicleitem', 'power_id')

        # Deleting field 'VehicleItem.heat'
        db.delete_column(u'shipBuilder_vehicleitem', 'heat_id')

        # Adding M2M table for field power on 'VehicleItem'
        m2m_table_name = db.shorten_name(u'shipBuilder_vehicleitem_power')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('vehicleitem', models.ForeignKey(orm[u'shipBuilder.vehicleitem'], null=False)),
            ('vehicleitempower', models.ForeignKey(orm[u'shipBuilder.vehicleitempower'], null=False))
        ))
        db.create_unique(m2m_table_name, ['vehicleitem_id', 'vehicleitempower_id'])

        # Adding M2M table for field heat on 'VehicleItem'
        m2m_table_name = db.shorten_name(u'shipBuilder_vehicleitem_heat')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('vehicleitem', models.ForeignKey(orm[u'shipBuilder.vehicleitem'], null=False)),
            ('vehicleitemheat', models.ForeignKey(orm[u'shipBuilder.vehicleitemheat'], null=False))
        ))
        db.create_unique(m2m_table_name, ['vehicleitem_id', 'vehicleitemheat_id'])

        # Adding M2M table for field avionics on 'VehicleItem'
        m2m_table_name = db.shorten_name(u'shipBuilder_vehicleitem_avionics')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('vehicleitem', models.ForeignKey(orm[u'shipBuilder.vehicleitem'], null=False)),
            ('vehicleitemavionics', models.ForeignKey(orm[u'shipBuilder.vehicleitemavionics'], null=False))
        ))
        db.create_unique(m2m_table_name, ['vehicleitem_id', 'vehicleitemavionics_id'])


    def backwards(self, orm):
        # Adding field 'VehicleItem.avionics'
        db.add_column(u'shipBuilder_vehicleitem', 'avionics',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['shipBuilder.VehicleItemAvionics']),
                      keep_default=False)

        # Adding field 'VehicleItem.power'
        db.add_column(u'shipBuilder_vehicleitem', 'power',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['shipBuilder.VehicleItemPower']),
                      keep_default=False)

        # Adding field 'VehicleItem.heat'
        db.add_column(u'shipBuilder_vehicleitem', 'heat',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['shipBuilder.VehicleItemHeat']),
                      keep_default=False)

        # Removing M2M table for field power on 'VehicleItem'
        db.delete_table(db.shorten_name(u'shipBuilder_vehicleitem_power'))

        # Removing M2M table for field heat on 'VehicleItem'
        db.delete_table(db.shorten_name(u'shipBuilder_vehicleitem_heat'))

        # Removing M2M table for field avionics on 'VehicleItem'
        db.delete_table(db.shorten_name(u'shipBuilder_vehicleitem_avionics'))
    ...
    models = {
        ...
        u'shipBuilder.vehicleitem': {
            ...
            'avionics': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['shipBuilder.VehicleItemAvionics']", 'symmetrical': 'False'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'displayName': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'heat': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['shipBuilder.VehicleItemHeat']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'power': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['shipBuilder.VehicleItemPower']", 'symmetrical': 'False'})
        },
