...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WeaponData.missile_count'
        db.add_column(u'shipBuilder_weapondata', 'missile_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WeaponData.missile_count'
        db.delete_column(u'shipBuilder_weapondata', 'missile_count')
