...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ItemPort.parentImage'
        db.add_column(u'shipBuilder_itemport', 'parentImage',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ItemPort.parentImage'
        db.delete_column(u'shipBuilder_itemport', 'parentImage')
