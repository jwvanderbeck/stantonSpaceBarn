...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VehicleImage'
        db.create_table(u'shipBuilder_vehicleimage', (
            ...
            ('ship', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shipBuilder.Vehicle'])),
        ))
        db.send_create_signal(u'shipBuilder', ['VehicleImage'])

        # Adding field 'Vehicle.views'
        db.add_column(u'shipBuilder_vehicle', 'views',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Vehicle.maximum_crew'
        db.add_column(u'shipBuilder_vehicle', 'maximum_crew',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Vehicle.empty_mass'
        db.add_column(u'shipBuilder_vehicle', 'empty_mass',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Vehicle.length'
        db.add_column(u'shipBuilder_vehicle', 'length',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Vehicle.width'
        db.add_column(u'shipBuilder_vehicle', 'width',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Vehicle.height'
        db.add_column(u'shipBuilder_vehicle', 'height',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Vehicle.thumbnail'
        db.add_column(u'shipBuilder_vehicle', 'thumbnail',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Vehicle.available'
        db.add_column(u'shipBuilder_vehicle', 'available',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Vehicle.manufacturer'
        db.add_column(u'shipBuilder_vehicle', 'manufacturer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shipBuilder.Manufacturer'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'VehicleItem.views'
        db.add_column(u'shipBuilder_vehicleitem', 'views',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'VehicleImage'
        db.delete_table(u'shipBuilder_vehicleimage')

        # Deleting field 'Vehicle.views'
        db.delete_column(u'shipBuilder_vehicle', 'views')

        # Deleting field 'Vehicle.maximum_crew'
        db.delete_column(u'shipBuilder_vehicle', 'maximum_crew')

        # Deleting field 'Vehicle.empty_mass'
        db.delete_column(u'shipBuilder_vehicle', 'empty_mass')

        # Deleting field 'Vehicle.length'
        db.delete_column(u'shipBuilder_vehicle', 'length')

        # Deleting field 'Vehicle.width'
        db.delete_column(u'shipBuilder_vehicle', 'width')

        # Deleting field 'Vehicle.height'
        db.delete_column(u'shipBuilder_vehicle', 'height')

        # Deleting field 'Vehicle.thumbnail'
        db.delete_column(u'shipBuilder_vehicle', 'thumbnail')

        # Deleting field 'Vehicle.available'
        db.delete_column(u'shipBuilder_vehicle', 'available')

        # Deleting field 'Vehicle.manufacturer'
        db.delete_column(u'shipBuilder_vehicle', 'manufacturer_id')

        # Deleting field 'VehicleItem.views'
        db.delete_column(u'shipBuilder_vehicleitem', 'views')
