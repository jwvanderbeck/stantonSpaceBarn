...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GameUpdateChange'
        db.create_table(u'shipBuilder_gameupdatechange', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shipBuilder.GameUpdateEntity'])),
        ))
        db.send_create_signal(u'shipBuilder', ['GameUpdateChange'])

        # Adding model 'GameUpdate'
        db.create_table(u'shipBuilder_gameupdate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'shipBuilder', ['GameUpdate'])

        # Adding model 'GameUpdateEntity'
        db.create_table(u'shipBuilder_gameupdateentity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('update', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shipBuilder.GameUpdate'])),
        ))
        db.send_create_signal(u'shipBuilder', ['GameUpdateEntity'])


    def backwards(self, orm):
        # Deleting model 'GameUpdateChange'
        db.delete_table(u'shipBuilder_gameupdatechange')

        # Deleting model 'GameUpdate'
        db.delete_table(u'shipBuilder_gameupdate')

        # Deleting model 'GameUpdateEntity'
        db.delete_table(u'shipBuilder_gameupdateentity')
    ...
    models = {
        ...
        u'shipBuilder.gameupdate': {
            'Meta': {'object_name': 'GameUpdate'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'shipBuilder.gameupdatechange': {
            'Meta': {'object_name': 'GameUpdateChange'},
            'description': ('django.db.models.fields.TextField', [], {}),
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['shipBuilder.GameUpdateEntity']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'shipBuilder.gameupdateentity': {
            'Meta': {'object_name': 'GameUpdateEntity'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'update': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['shipBuilder.GameUpdate']"})
        },
