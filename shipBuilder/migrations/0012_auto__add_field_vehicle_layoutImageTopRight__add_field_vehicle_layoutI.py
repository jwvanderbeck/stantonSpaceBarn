...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vehicle.layoutImageTopRight'
        db.add_column(u'shipBuilder_vehicle', 'layoutImageTopRight',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Vehicle.layoutImageTopLeft'
        db.add_column(u'shipBuilder_vehicle', 'layoutImageTopLeft',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Vehicle.layoutImageBottomRight'
        db.add_column(u'shipBuilder_vehicle', 'layoutImageBottomRight',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Vehicle.layoutImageBottomLeft'
        db.add_column(u'shipBuilder_vehicle', 'layoutImageBottomLeft',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'ItemPort.parentVehicle'
        db.alter_column(u'shipBuilder_itemport', 'parentVehicle_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shipBuilder.Vehicle'], null=True))

    def backwards(self, orm):
        # Deleting field 'Vehicle.layoutImageTopRight'
        db.delete_column(u'shipBuilder_vehicle', 'layoutImageTopRight')

        # Deleting field 'Vehicle.layoutImageTopLeft'
        db.delete_column(u'shipBuilder_vehicle', 'layoutImageTopLeft')

        # Deleting field 'Vehicle.layoutImageBottomRight'
        db.delete_column(u'shipBuilder_vehicle', 'layoutImageBottomRight')

        # Deleting field 'Vehicle.layoutImageBottomLeft'
        db.delete_column(u'shipBuilder_vehicle', 'layoutImageBottomLeft')


        # Changing field 'ItemPort.parentVehicle'
        db.alter_column(u'shipBuilder_itemport', 'parentVehicle_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['shipBuilder.Vehicle']))
