...
urlpatterns = patterns('stantonSpaceBarn.views',
    ...
    url(r'^test/$', 'testView'),
	url(r'^ship/([a-zA-Z0-9_-]+)', 'shipLayout'),
	url(r'^ships/$', 'phase2ShipList'),
	url(r'^variant/([0-9]+)', 'displayVariant'),
	url(r'^variants/', 'phase2VariantList'),
	...
	# url(r'^phase2/ship/([a-zA-Z0-9_&-]+)', 'shipLayoutTest'),
	...
	url(r'^gameupdates/$', 'gameUpdateList'),
	url(r'^gameupdate/([0-9]+)$', 'gameUpdate'),
	url(r'^gameupdatebyentity/([a-zA-Z0-9_&-]+)$', 'gameUpdatesByEntity'),
